...
exports.seed = async function(knex) {
  ...
  await knex('teams').insert([
    ...
    {id: 2, team_name: 'CI Team 1', location: {"city_base": "Camp Arifjan", "country": "Kuwait"}, comms_status: 'yellow', personnel_status: 'red', equipment_status: 'green', is_archived: false},
    ...
    {id: 14, team_name: 'CI Team 5', location: {"city_base": "Air Base Ali Al Salem", "country": "Kuwait"}, comms_status: 'green', personnel_status: 'red', equipment_status: 'green', is_archived: false},
